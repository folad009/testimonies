                ...
                <div className="post-panel">
                    ...
                    <div className="post-metadata">
                        ...
                        <div className="post-info">
                            <div data-react-className="PopoverLink"><span className="popover-link" data-reactroot=""><a href="{null}">{items.profile.user.name}</a></span></div>
                    ...
                    <div className="post-stats clearfix">
                        ...
                        <div className="response-count pull-right">
                            <a className="response-count" href="{null}">0 responses</a>
                        </div>
                    </div>
                </div>
                )}
