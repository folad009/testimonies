...
class AsideFeed extends Component {
    render () {
        const authors = this.props._articles
            ...
            .map((__article)=>
                <a href='{null}' className="tag">{__article}</a>
            )
    ...
    <div>
        <aside className="col-md-4 main-sidebar">
            <h4 className="small-heading border-top">Popular Authors</h4>
            ...
            <h4 className="small-heading border-top">Popular Testimonies</h4>
